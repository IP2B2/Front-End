...
export async function createCerereInchiriereSimplu(startDateString, returnDateString, equipmentId) {
    'use client';
    var resolution = {
    ...
    try {
        ...
        const response = await axios.post('/api/home/inchiriere/echipament-simplu', {
